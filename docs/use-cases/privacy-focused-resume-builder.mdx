...
description: "Understand the privacy-focused parts of HeadCV, including open source transparency, self-hosting, public sharing controls, and optional AI provider configuration."
---

HeadCV is a privacy-focused resume builder because it is open source, can be self-hosted, supports private-by-default resume editing, and makes sharing and optional AI features explicit choices.
...
The source code is available on [GitHub](https://github.com/AHMED9937/headcv), so you can inspect how the application works. If you need direct control over infrastructure, storage, auth providers, and deployment policy, you can self-host HeadCV.
...
This build does not include AI-assisted features; every resume is created, edited, exported, and shared without sending data to an AI provider.
