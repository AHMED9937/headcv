---
title: "Quickstart"
description: "Get started with HeadCV in minutes  use our hosted version or deploy your own instance"
---

## Options

HeadCV offers flexibility in how you want to use it. Choose the option that best fits your needs:
...
The easiest way to use HeadCV is through our cloud version at [headcv.com](https://headcv.com). **This service is completely free and will always remain free.**

<Steps>
	<Step title="Create an Account">
		Visit [headcv.com](https://headcv.com) and sign up for free using your email, or sign in with your GitHub or Google
		account.
	</Step>
...
For users who prefer complete control over their data, you can deploy HeadCV on your own infrastructure using Docker.
...
<Steps>
	<Step title="Clone the Repository">
		```bash
		git clone https://github.com/AHMED9937/headcv.git
		cd headcv
		```
	</Step>
...
```
	...
	- **Redis**  Required for the AI Agent workspace
    	...
    	- **HeadCV**  The main application
    </Step>

    <Step title="Access Your Instance">
    	Once all services are running, access your HeadCV instance at:
...
| `headcv` | 3000 | The main HeadCV application                 |

<Note>
  Saved AI provider management requires `ENCRYPTION_SECRET`, and the AI Agent workspace requires both `REDIS_URL` and
  `ENCRYPTION_SECRET`. Other HeadCV features can run without them. Agent attachments and other private objects
...
| `APP_URL`      | Public URL of your Application | `https://headcv.com`                   |
...
<CardGroup cols={2}>
  <Card title="Development Setup" icon="code" href="/contributing/development">
    Set up a development environment to contribute or customize HeadCV.
  </Card>
...
<Note>
  **Having trouble?** Check our [GitHub Issues](https://github.com/AHMED9937/headcv/issues) or reach out via
  [email](mailto:hello@headcv.com).
</Note>
