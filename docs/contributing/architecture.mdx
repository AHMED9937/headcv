...
> This fork (NexaCV v1) removes all AI and MCP features from the upstream project. `packages/ai`, `packages/mcp`, and the `/mcp` route do not exist in this codebase; the original code is preserved in the `archive/upstream-ai-mcp-v5.1.6` branch.
