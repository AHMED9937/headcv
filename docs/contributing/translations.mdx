...
description: "Help translate HeadCV into your language using Crowdin"
---

HeadCV is used by people all around the world, and translations help make the app accessible to everyone. If you speak a language other than English, you can help by contributing translations.

---

## How Translations Work

HeadCV uses [Crowdin](https://crowdin.com/) as its localization management platform. Crowdin provides a user-friendly interface where translators can contribute translations without needing to write code or work with files directly.

<Info>
  The HeadCV Crowdin project is available at
  [https://crowdin.com/project/headcv](https://crowdin.com/project/headcv).
</Info>
...
<Steps>
    ...
    <Step title="Join the HeadCV Project">
    	Navigate to the [HeadCV project on Crowdin](https://crowdin.com/project/headcv) and click **Join**
...
<Warning>
  ...
  project](https://crowdin.com/project/headcv).
</Warning>

To request a new language:

1. Go to the [GitHub Issues](https://github.com/AHMED9937/headcv/issues) page
2. Click **New Issue**
3. Select the appropriate template or create a blank issue
4. Title it something like: "Add [Language Name] to HeadCV"
...
Translations submitted on Crowdin are synced to the codebase periodically. Once merged, they will be included in the next release of HeadCV.
...
<CardGroup cols={2}>
  ...
  <Card icon="github" title="GitHub Issues" href="https://github.com/AHMED9937/headcv/issues">
...
Thank you for helping make HeadCV accessible to users worldwide!
