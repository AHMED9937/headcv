...
HeadCV can export your resume in three formats:
...
| **JSON** | Backups, restoring a resume later, importing into another HeadCV account, or sharing structured data with an AI assistant. |
...
- printing;
- sharing a finished copy outside HeadCV.
