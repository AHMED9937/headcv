---
title: "Using the API"
description: "Learn how to create API keys and authenticate requests to the HeadCV API"
---

<Steps>
  <Step title="Sign in to the dashboard">
    Head over to [https://headcv.com](https://headcv.com) and sign in with your account credentials.
  </Step>
...
<Step title="Navigate to API Keys settings">
  ...
  <Step title="Open the API reference">
    ...
    <Tip>
      You can also open it directly here: [API Reference](https://docs.headcv.com/api-reference).
    </Tip>
  ...
  <Step title="Authenticate requests with x-api-key">
    ...
    <Info>
      If you're self-hosting, replace <code>https://headcv.com</code> with your instance URL. The API is served under <code>/api/openapi</code>.
    </Info>

    ```bash
    curl "https://headcv.com/api/openapi/resumes" \
