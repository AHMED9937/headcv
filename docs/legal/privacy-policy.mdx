...
description: "How HeadCV handles personal data, cookies, uploads, and printing."
---

## Overview

This Privacy Policy explains how **HeadCV** (the “Service”) collects, uses, stores, and shares information when you use it.

HeadCV is open-source and can be operated in different ways (for example, by the official hosted service, or by an organization/self-hosted deployment). The specific data controller for your use depends on who operates the instance you are using.

- **Service Operator**: HeadCV
- **Contact**: hello@headcv.com
- **Service URL**: https://headcv.com
...
<Note>
  **Note for self-hosted deployments:** If you are using the official hosted service at <code>headcv.com</code>, the
  project's published support contact is <code>hello@headcv.com</code>. Replace the placeholders above with the
...
HeadCV is a resume builder that lets you:
