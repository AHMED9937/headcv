...
- Always use the full JSON Pointer path; do not omit `/sections` for section families.
...
- `/basics/name`  visible resume name
- `/summary/content`  summary text
- `/sections/skills/items/0/keywords`  keywords of the first skill item
- `/sections/skills/items/0/keywords/-`  append a keyword to the first skill item
- `/sections/projects/items/0/description`  first project description
- `/sections/experience/items/0/company`  first experience company name
