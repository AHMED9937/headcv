...
HeadCV provides security updates for version `5.0.x` and newer.
...
- If that is unavailable, email `hello@headcv.com` with the subject
  `Security Vulnerability: HeadCV`.
